...
const CurrentWeather: React.FC<CurrentWeatherProps> = ({ data }) => {
  ...
  return (
    <div className="current-weather-container mx-auto mt-6 p-4 w-1/3 border border-black rounded-md shadow-md   bg-white">
      <div className="text-sm font-regular mb-1 ">Current Weather</div>
      <div className="divider mb-2 border-b border-black"></div>
      <div className="mb-4 flex items-center justify-center">
        <img src={iconUrl} alt={data.description} className="mr-4 w-24 h-24 " />
        <div>
